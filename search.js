...
api[0].list.push({
    alias: 'LogisticController',
    order: '6',
    link: 'logisticcontroller',
    desc: 'LogisticController',
    list: []
})
api[0].list[5].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/providers',
    methodId: 'd0ceeeae50509b2277417290bf67c5bb',
    desc: 'List Logistic Providers',
});
api[0].list[5].list.push({
    order: '2',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/settings/{provider}',
    methodId: 'fcbbc3f8b9c912295749c27fcaef3c95',
    desc: 'Get Logistic Setting',
});
api[0].list[5].list.push({
    order: '3',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/settings/{provider}',
    methodId: '255ae0a094af51268ab614857c2c98bb',
    desc: 'Update Logistic Setting',
});
api[0].list[5].list.push({
    order: '4',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/quotes',
    methodId: 'b79be5964c3c882ef068aac28d763259',
    desc: 'Create Delivery Quotes',
});
api[0].list[5].list.push({
    order: '5',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/konga/locations',
    methodId: '7dc3d80d269656b0d4e614ba1767b0d5',
    desc: 'Get Konga Locations',
});
api[0].list[5].list.push({
    order: '6',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/konga/states',
    methodId: 'c53f4f0648667826d6c2b44be04b0bfb',
    desc: 'Get Konga States',
});
api[0].list[5].list.push({
    order: '7',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/konga/lgas',
    methodId: '3e1fc42e7cc6abb73da88aef50c90c55',
    desc: 'Get Konga LGAs',
});
api[0].list[5].list.push({
    order: '8',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/orders/{orderId}/waybill',
    methodId: '029758aa46a618084028852cbf80bf51',
    desc: 'Generate Order Waybill',
});
api[0].list[5].list.push({
    order: '9',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/logistics/orders/{orderId}/tracking',
    methodId: '74fab6ba77eea7097e2498e1d9d3dc3e',
...
api[0].list[13].list.push({
    ...
    methodId: '76fe779393a700f8fc9b1137efcaacf0',
...
api[0].list[13].list.push({
    ...
    methodId: '5ed350c14b0c6bb5b1dda9cd859811cd',
...
api[0].list[32].list.push({
    ...
    methodId: '798ac9ace877be660455c317414fb7f9',
...
api[0].list[32].list.push({
    ...
    methodId: '7702f4aaff386d6ee5f5127333767825',
...
api[0].list[32].list.push({
    ...
    methodId: '29e35432605a73177cd5d700dd18f985',
...
api[0].list[32].list.push({
    ...
    methodId: 'b0bfdeb39966975948c0131501875d30',
...
api[0].list[32].list.push({
    ...
    methodId: '4bced46c601cb3c633cd256e7c10b419',
...
api[0].list[32].list.push({
    ...
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/admin/merchants/{tenantId}/payment-secrets',
    methodId: 'c3baa2e61820a4b9ebad5cad399fe0c1',
...
api[0].list.push({
    alias: 'OrderLogisticController',
    order: '36',
    link: 'orderlogisticcontroller',
    desc: 'OrderLogisticController',
    list: []
})
api[0].list[35].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/orders/{orderId}/logistics/waybill',
    methodId: '9262fbbf114267bec7b9523ecdf5a13d',
    desc: 'Generate Order Waybill',
});
api[0].list[35].list.push({
    order: '2',
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/orders/{orderId}/logistics/tracking',
    methodId: '2132ca155c1fbf6bde2668d26b8c72df',
    desc: 'Track Order Shipment',
});
api[0].list.push({
...
api[0].list[49].list.push({
    ...
    methodId: '5a0f98cfb1273497d5efaba8d9908399',
...
api[0].list[49].list.push({
    ...
    deprecated: 'false',
    url: 'https://api.shopsynch.com/v1/admin/cache',
    methodId: '58f927118fd452bfa15309fc8f6f32a8',
...
api[0].list[49].list.push({
    ...
    methodId: '9e7b46b5f4b603bb8471e02200421347',
...
api[0].list[49].list.push({
    ...
    methodId: '7997d1f20e29ee31248bb923dad305ff',
...
api[0].list[54].list.push({
    ...
    methodId: 'eae05f52bc66ce8dd957a4ff35498244',
...
api[0].list[54].list.push({
    ...
    methodId: '9ee8ad5acc2a03deaebe7b642cb09237',
...
api[0].list[54].list.push({
    ...
    methodId: '978767fc8ddbb7d9fa28b25ee96e35cf',
...
api[0].list[62].list.push({
    ...
    methodId: '07d3630fdd3d1290aa8d5d5c8af8399e',
    desc: 'List All Users',
});
api[0].list[62].list.push({
    order: '2',
    ...
    methodId: '0756bfea991d37f4575ceabd79246890',
...
api[0].list[62].list.push({
    ...
    methodId: 'e80d180c0a0e4dd3408848a1508d6163',
